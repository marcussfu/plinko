<template>
    <div class="flex overflow-hidden rounded-md">
        ...
        <div
          class="bg-blue-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-blue-500 active:bg-blue-700 sm:text-base cursor-pointer relative"
